...
def image_mixer_api(path_1, path_2, path_3, path_4):
    """
    ...
    result = client.predict(
			    ...
			    path_3,	# str (filepath or URL to image) in 'Image' Image component
				path_4,	# str (filepath or URL to image) in 'Image' Image component
				"",	# str (filepath or URL to image) in 'Image' Image component
				1.2,	# int | float (numeric value between 0 and 5) in 'Strength' Slider component
				1.2,	# int | float (numeric value between 0 and 5) in 'Strength' Slider component
				1.2,	# int | float (numeric value between 0 and 5) in 'Strength' Slider component
				1.2,	# int | float (numeric value between 0 and 5) in 'Strength' Slider component
